...
export default ({ navigation }) => {
  ...
  const [textConfirmPassword, setTextConfirmPassword] = useState(
    "Mật khẩu phải là 6 ký tự số"
  );
  const [validatePass, setValidatePass] = useState(false);
  const [snackBar, setSnackBar] = useState(false);
  const [snackBarVerify, setSnackBarVerify] = useState(false);
  const [textPhone, setTextPhone] = useState(
    "Số điện thoại phải là 10 ký tự số và bắt đầu là ký tự số 0"
  );
            ...
            <VStack space={3} mt="5">
              <FormControl>
                ...
                <Input
                  value={name}
                  onChangeText={(e) => {
                    setName(e), setValidateName(false);
                  }}
                />
                {validateName && (
              ...
              <FormControl>
                ...
                <Input
                  value={phone}
                  onChangeText={(e) => {
                    setPhone(e), setValidateNumberPhone(false);
                  }}
                />
                {validateNumberPhone && (
              ...
              <FormControl>
                ...
                <Input
                  ...
                  onChangeText={(e) => {
                    setPassword(e), setValidatePass(false);
                  }}
                />
                {validatePass && (
              ...
              <FormControl>
                ...
                <Input
                  ...
                  secureTextEntry={true}
                  onChangeText={(e) => {
                    setConfirmPassword(e), setValidateConfirmPassword(false);
                  }}
                />
                {validateConfirmPassword && (
